...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hazeDesert = __webpack_require__(12);
	
	var _hazeDesert2 = _interopRequireDefault(_hazeDesert);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var canvas = document.querySelector('.background__canvas');
	
	var textureAlign = { x: 0.9, y: 0.9 };
	var textures = [{
	  file: '../images/heat/desert.jpg',
	  name: 'image',
	  align: textureAlign,
	  scale: { x: 1, y: 1 }
	}, {
	  file: '../images/heat/desert-maps.jpg',
	  name: 'maps',
	  align: textureAlign,
	  scale: { x: 0.8, y: 0.8 }
	}, {
	...
	var contents = [loadContent('../images/heat/desert-title.svg', document.querySelector('.background__title--big')), loadContent('../images/heat/desert-title-medium.svg', document.querySelector('.background__title--medium')), loadContent('../images/heat/desert-title-small.svg', document.querySelector('.background__title--small'))];
